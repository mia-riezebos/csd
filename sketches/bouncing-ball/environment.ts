...
export let b = 0.9; // bounciness / restituion coëfficient
export let d = 0; // drag / air restistance               (0 to disable)

/* Object */
export let amount = 50; // amount of initial balls
export let size = 50; // average size of initial balls
export let velocity = 2; // average velocity of initial balls
